...
END;
        ...
        $settings .= "\n" . sprintf('                                    <tr class="jeopardy"><td data-toggle="tooltip" title="Enable/disable hiding of scores between teams">%s: </td><td><input id="%s" type="checkbox"%s></td></tr>', "Hide team scores", "hide_team_scores", parseBool(getSetting(Setting::HIDE_TEAM_SCORES)) ? " checked" : "");
